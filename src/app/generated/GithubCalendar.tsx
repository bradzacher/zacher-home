...
const GithubCalendar = injectSheet(styles)(({ classes }: Props) => (
    <svg width='100%' viewBox='0 0 710 120'>
        <g
            ...
            data-hydro-click='{"event_type":"user_profile.click","payload":{"profile_user_id":7462525,"target":"CONTRIBUTION_CALENDAR_SQUARE","user_id":null,"client_id":null,"originating_request_id":"5306:2784:7E2ECA:BEE654:5D23D891","originating_url":"https://github.com/users/bradzacher/contributions","referrer":null}}'
            data-hydro-click-hmac='7db738aaf4f53b61d011b7888c2d3155eef4da2cd5a6f11b3a14d234703c80b8'
        >
            ...
            <text x='14' y='-7' className={classes.month}>
                Jul
            </text>
            <text x='66' y='-7' className={classes.month}>
                Aug
            </text>
            <text x='118' y='-7' className={classes.month}>
                Sep
            </text>
            <text x='183' y='-7' className={classes.month}>
                Oct
            </text>
            <text x='235' y='-7' className={classes.month}>
                Nov
            </text>
            <text x='287' y='-7' className={classes.month}>
                Dec
            </text>
            <text x='352' y='-7' className={classes.month}>
                Jan
            </text>
            <text x='404' y='-7' className={classes.month}>
                Feb
            </text>
            <text x='456' y='-7' className={classes.month}>
                Mar
            </text>
            <text x='521' y='-7' className={classes.month}>
                Apr
            </text>
            <text x='573' y='-7' className={classes.month}>
                May
            </text>
            <text x='625' y='-7' className={classes.month}>
                Jun
            </text>
            <text textAnchor='start' className={classes.wday} dx='-10' dy='22'>
                Mon
            </text>
            <text textAnchor='start' className={classes.wday} dx='-10' dy='48'>
                Wed
            </text>
            <text textAnchor='start' className={classes.wday} dx='-10' dy='73'>
                Fri
            </text>
        </g>
    </svg>
